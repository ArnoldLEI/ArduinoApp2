...
class MainActivity : AppCompatActivity() {
    ...
    fun intRef(){
        ...
        ledRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ib_led_red.setImageResource(R.drawable.black)
                ib_led_green.setImageResource(R.drawable.black)
                ib_yellow_led.setImageResource(R.drawable.black)
                val value = snapshot.value.toString().toInt()
                when(value) {
                    1 -> ib_led_red.setImageResource(R.drawable.red)
                    2 -> ib_led_green.setImageResource(R.drawable.green)
                    3 -> ib_yellow_led.setImageResource(R.drawable.yellow)
                }
            }
